package com.st.logger.preference;
  ...
  private boolean onPostPreferenceCheck(String key) {
    ...
    if (key.equals(Settings.PREFERENCE_CPUUSAGE)
      ...
      getApplication().stopService(
          new Intent(getApplication(), STMonitorService.class));
