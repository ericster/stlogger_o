...
import com.st.logger.preference.STPreference;
import com.st.logger.settings.Settings;
import com.st.logger.util.HttpUtil;
import com.st.logger.util.ProcessUtil;
import com.st.logger.util.SoakService;
import com.st.logger.util.UserInterfaceUtil;
...
public class ConnectionFragment extends ListFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Intent intent = new Intent(this.getActivity(), SoakService.class);
    ...
    private void exportLog(String fileName) {
        ...
        try {
            ...
            for (int index = 0; index < data.size(); index++) {
                ...
                logWriter.write(getConnectionInfoString(item));
            }
    ...
    private void onSettingClick() {
        Intent settings = new Intent(getActivity(), STPreference.class);
    ...
    private class ConnectionListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (position % 2 == 0)
                sv.setBackgroundColor(getResources().getColor(R.color.dkgrey_stmonitor));
            else
                sv.setBackgroundColor(getResources().getColor(R.color.black_stmonitor));
    ...
    class QueryWhois {
        ...
        public QueryWhois(String QueryIP) {
            ...
            String URL = "http://whois.arin.net/rest/ip/" + QueryIP + ".json";
