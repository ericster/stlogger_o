...
import com.st.logger.core.dmesgLevel;
import com.st.logger.core.logPriority;
import com.st.logger.core.logcatInfo;
import com.st.logger.core.logcatInfoList;
  ...
  private class MessageListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
      ...
      if (selectedData.containsKey(position) == true)
        holder.bkcolor = getResources().getColor(R.color.selected_stmonitor);
      else if (position % 2 == 0)
        holder.bkcolor = getResources().getColor(R.color.dkgrey_stmonitor);
      else
        holder.bkcolor = getResources().getColor(R.color.black_stmonitor);
