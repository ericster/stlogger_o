...
import com.st.logger.util.CoreUtil;
...
public class ProcessFragment extends ListFragment implements ipcClientListener {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    // prepare draw color
    itemColor = new int[3];
    itemColor[oddItem] = getResources().getColor(R.color.dkgrey_stmonitor);
    itemColor[evenItem] = getResources().getColor(R.color.black_stmonitor);
    itemColor[selectedItem] = getResources().getColor(R.color.selected_stmonitor);
