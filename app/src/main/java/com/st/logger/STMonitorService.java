...
import com.st.logger.core.cpuInfo;
import com.st.logger.core.cpuInfoList;
import com.st.logger.core.networkInfo;
import com.st.logger.core.networkInfoList;
...
import com.st.logger.settings.Settings.NotificationType;
import com.st.logger.settings.Settings.StatusBarColor;
...
public class STMonitorService extends Service implements ipcClientListener {
  ...
  private void initializeNotification() {
    ...
    Intent notificationIntent = new Intent(this, STMonitor.class);
